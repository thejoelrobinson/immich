...
{#if dragStartTarget}
  ...
  <div
    class="fixed inset-0 flex h-full w-full flex-col items-center justify-center bg-gray-100/90 text-bentonville-blue dark:bg-bentonville-blue/90 dark:text-gray-300"
