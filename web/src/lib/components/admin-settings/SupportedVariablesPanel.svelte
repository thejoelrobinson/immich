...
<div class="p-4 mt-2 text-xs bg-gray-200 rounded-lg dark:bg-gray-700 dark:text-gray-200">
  <div class="flex gap-12">
    <div>
      <p class="uppercase font-medium text-walmart-blue">{$t('filename')}</p>
      <ul>
    ...
    <div>
      <p class="uppercase font-medium text-walmart-blue">{$t('filetype')}</p>
      <ul>
    ...
    <div>
      <p class="uppercase font-medium text-walmart-blue">{$t('other')}</p>
      <ul>
