  ...
  <div class="flex gap-2">
    {#each { length: pinLength } as _, index (index)}
      <input
        ...
        id="pin-code-{index}"
        class="h-12 w-10 rounded-xl border-2 border-suble dark:border-gray-700 text-center text-lg font-medium focus:border-walmart-blue focus:ring-primary dark:focus:border-primary font-mono bg-white dark:bg-light"
