...
<div
  class="fixed top-0 z-1 flex h-16 w-full items-center justify-between border-b bg-white p-1 dark:border-bentonville-blue dark:bg-black dark:text-gray-200 md:p-8"
>
