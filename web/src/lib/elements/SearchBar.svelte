...
<div
  class="flex items-center text-sm {roundedBottom
    ? 'rounded-2xl'
    : 'rounded-t-lg'} bg-gray-200 p-2 dark:bg-everyday-blue gap-2 place-items-center h-full"
>
  <IconButton
    shape="round"
    color="secondary"
  ...
  />
  <input
    class="w-full gap-2 bg-gray-200 dark:bg-everyday-blue dark:text-white"
    type="text"
    {placeholder}
    bind:value={name}
    bind:this={inputRef}
