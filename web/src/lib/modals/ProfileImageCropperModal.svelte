...
<Modal size="small" title={$t('set_profile_picture')} {onClose}>
  <ModalBody>
    <div class="flex place-items-center items-center justify-center">
      <div
        class="relative flex aspect-square w-62.5 overflow-hidden rounded-full border-4 border-walmart-blue bg-sky-blue dark:border-sky-blue dark:bg-walmart-blue"
      >
